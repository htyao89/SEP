...
class FGVCAircraft(DatasetBase):
    ...
    def __init__(self, cfg):
        ...
        train = self.read_data(cname2lab, "images_variant_train.txt","images_manufacturer_train.txt")
        val = self.read_data(cname2lab, "images_variant_val.txt","images_manufacturer_val.txt")
        test = self.read_data(cname2lab, "images_variant_test.txt","images_manufacturer_test.txt")
    ...
    def read_data(self, cname2lab, split_file,split_file1):
